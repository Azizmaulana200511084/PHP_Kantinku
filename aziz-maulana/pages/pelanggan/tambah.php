...
<body>
    ...
    <header style="color: white;">
        <h3 style="text-align: center;">Formulir Pendaftaran Pelanggan Baru</h3>
    </header>
    ...
    <form action="proses-tambah.php" method="POST">
        ...
        <table>
            <tr>
                ...
                <td><input type="text" name="nmplg" placeholder="Nama lengkap" /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="hp" placeholder="Nomor Handphone" /></td>
            </tr>
            <tr>
