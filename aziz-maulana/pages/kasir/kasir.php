...
<body>
    ...
    <p>
        <?php
            if($_GET['status_pendaftaran'] == 'ditambahkan'){
                echo "Pendaftaran Kasir baru berhasil!";
            } else {
    ...
    <p>
        <?php
            if($_GET['status_update'] == 'update'){
                echo "Pembaharuan Kasir berhasil di perbaharui!";
            } else {
                echo "Pendaftaran gagal!";
            }
        ?>
    ...
    <tbody> 
        ...
        while($kasir = mysqli_fetch_array($query)){
            ...
            echo "<td>".$kasir['idksr']."</td>"; 
            echo "<td>".$kasir['nmksr']."</td>"; 
            echo "<td>".$kasir['jk']."</td>"; 
            echo "<td>".$kasir['alamat']."</td>"; 
            echo "<td>".$kasir['hp']."</td>"; 
 
            echo "<td style='background-color:red; color:yellow;'>"; 
            echo "<a href='edit.php?idksr=".$kasir['idksr']."' style='color:white;'class='eh'>Edit</a> | "; 
            echo "<a href='hapus.php?idksr=".$kasir['idksr']."' style='color:white;'class='eh'>Hapus</a>"; 
            echo "</td>"; 
 
            echo "</tr>"; } 
    ?> 
    </tbody>
    <p style="color: white; font-size:large; text-align:center; background-color: red;">TABEL KASIR</p>
